...
function App() {
  return (
    <div className="relative bg-white overflow-hidden h-full mt-8">
      <div className="max-w-full mx-auto md:px-14">
                ...
                <div className="relative pt-6 px-4 sm:px-6 lg:px-8">
                  ...
                  >
                    ...
                    <div className="hidden md:block md:ml-10 md:pr-4 md:space-x-16">
                      {navigation.map((item) => (
                        <a key={item.name} href={item.href} className="font-medium text-black hover:text-blue-600">
                          {item.name}
                        </a>
                      ))}
                    </div>
